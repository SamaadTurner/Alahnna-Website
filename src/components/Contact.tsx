  ...
  return (
    <section className="bg-white dark:bg-gray-900" id='contact'>
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <p className="mb-8 lg:mb-16 font-light text-center text-black dark:text-gray-400 sm:text-xl">Ready to book? Please send us your information and the date of your event; we will get back to you in 1 to 2 business days. Thank you!</p>
        <form onSubmit={handleSubmit} className="space-y-8">
          <div>
            <label htmlFor="name" className="block mb-2 text-sm font-medium text-black dark:text-gray-300">Your Name</label>
            <input
              type="text"
              id="name"
              value={name}
          ...
          <div className="sm:col-span-2">
            ...
            <textarea
              ...
              className="block p-2.5 w-full text-sm text-black dark:text-white bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
          ...
          <button
            type="submit"
            className="py-3 px-5 text-sm font-medium text-center text-black rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 border border-black"
          >
            Send email
          </button>
        </form>
