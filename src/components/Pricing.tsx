    ...
    <section className={`bg-background py-8`} id="pricing">
      <div className={`container mx-auto px-2 pt-4 pb-12 text-primary`}>
        ...
        >
          {/* Bronze Plan */}
          <div
            className={`flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-background mt-4 text-black`}
          >
            <div
              className={`flex-1 bg-background text-gray-600 rounded-t rounded-b-none overflow-hidden shadow text-bronze`}
            >
            ...
            >
              <div
                className={`w-full pt-6 text-3xl text-gray-600 font-bold text-center text-bronze`}
              >
                {firstPlan?.price}
          ...
          {/* Gold Plan */}
          <div
            className={`flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-background mt-4 sm:-mt-6 shadow-lg z-10 text-gold`}
          >
            <div
